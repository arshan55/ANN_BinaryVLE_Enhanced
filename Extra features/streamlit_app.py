"""
Interactive Web Application for ANN Binary VLE Predictor

This Streamlit application provides a user-friendly interface for:
- Real-time vapor composition predictions
- Model performance analysis
- Azeotrope detection visualization
...
def main():
    ...
    # Load model results
    results_dir = st.sidebar.text_input("Results Directory", value="outputs_enhanced")
